...
\usepackage{multicol} % Required for making multi-column lists
...
\newcommand{\customtitle}[2]{ % Define the \heading command
...
% \vspace{#2} % White space above the subheading
{\begin{flushleft}
    \Large\textbf{#1}
\end{flushleft}} % The subheading style
\vspace{#2} % White space below the subheading
}

%----------------------------------------------------------------------------------------
%	SUBHEADING STYLE
%----------------------------------------------------------------------------------------
\newcommand{\listheading}[2]{
% \vspace{#2} % White space above the subheading
{\begin{flushleft}
    \textbf{#1}
\end{flushleft}} % The subheading style
